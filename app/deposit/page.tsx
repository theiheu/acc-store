      ...
      <div className="grid gap-8 lg:grid-cols-2">
        ...
        <div className="space-y-6">
          ...
          <div className="rounded-xl border border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900 shadow-sm p-6">
            <h2 className="text-lg font-semibold mb-4">Nhập số tiền cần nạp</h2>
            ...
            <div className="flex gap-3">
              ...
              {showQR && (
                <button
                  onClick={handleReset}
                  className="px-4 py-3 border border-gray-300 dark:border-gray-700 text-gray-700 dark:text-gray-300 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors cursor-pointer"
                >
                  Làm mới
                </button>
              )}
...
Nội dung: ${transferContent}`;
            ...
            <div className="rounded-xl border border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900 shadow-sm p-8 text-center">
              <div className="w-24 h-24 mx-auto mb-4 rounded-full bg-gray-100 dark:bg-gray-800 flex items-center justify-center">
                <span className="text-4xl">📱</span>
              </div>
              <h3 className="text-lg font-semibold mb-2">Mã QR chuyển khoản</h3>
              <p className="text-gray-600 dark:text-gray-400 text-sm">
                Nhập số tiền và nhấn "Tạo mã QR" để hiển thị thông tin chuyển
                khoản
              </p>
            </div>
          )}
